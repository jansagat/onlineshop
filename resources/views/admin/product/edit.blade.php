                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="x_content">
                                <br/>
                                <form method="post" action="{{route('product.update', $product->id)}}" id="demo-form2"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @else
                                        <input type="checkbox" name="available" value="1"> Yes<br>
                                        <input type="checkbox" name="available" value="0" {{'checked'}}> No<br>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label for="original_url">Original Url</label>
                                        <input type="text" class="form-control" id="original_url" name="original_url" value="{{$product->original_url}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="ali_id">Aliexpress ID</label>
                                        <input type="text" class="form-control" id="ali_id" name="ali_id" value="{{$product->ali_id}}">
                                    </div>
                                    <div class="form-group">
